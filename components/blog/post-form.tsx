  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      <div>
        ...
        <div className="overflow-hidden rounded-2xl border border-border/40 shadow-sm focus-within:border-rose-500/50 focus-within:ring-2 focus-within:ring-rose-500/20 transition-all">
          <RichTextEditor
            content={content}
            onChange={setContent}
