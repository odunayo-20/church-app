  ...
  return (
    <footer className="w-full border-t border-border/40 bg-card text-card-foreground">
      <div className="container mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-4">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              and serving our neighbors. Join us on this journey of faith and
              transformation.
            </p>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              <div>
                <p className="font-bold text-foreground">Sunday Worship</p>
              ...
              <div>
                <p className="font-bold text-foreground">Friday Prayer</p>
                <p>6:00 PM - 7:00 PM</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-16 border-t border-border/40 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-muted-foreground">
          <p>
